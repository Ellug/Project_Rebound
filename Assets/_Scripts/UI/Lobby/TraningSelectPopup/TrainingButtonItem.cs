...
public class TrainingButtonItem : MonoBehaviour
{
    ...
    [SerializeField] private Image _imgButtonBackground;
    ...
    public void Setup(
        ...
        bool centerName = false)
    {
        ApplyButtonSprite(buttonSprite);

        _txtName.text = trainingName;
        _txtName.alignment = centerName
    ...
    private void ApplyButtonSprite(Sprite buttonSprite)
    {
        _imgButtonBackground.sprite = buttonSprite;
    }
}
